...
<body>
	...
	<section id="contenedor">
		...
		<section>
				...
				<div class="container">
		<form class="form-horizontal" action="turnos_triaje_consulta_fechas_mostrar.php" method="get">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<button id="singlebutton" name="singlebutton" class="btn btn-success">Consultar</button>
						</div>
					</div>
