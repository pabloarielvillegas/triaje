...
<h2 align="Center">Notificación a Sala de Espera</h2> 
...
<div class="table-responsive">
  ...
  <?php
     ...
     ?> 
      ...
      <td><a href="turnos_triaje_llamar_modificar.php?idtr=<?php echo $fila->idtr?>"><input type='button' name='up' id='up' value='Llamar' class="btn btn-default btn-lg btn-success"></a></td>
