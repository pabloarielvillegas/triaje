...
// Array de objetos 
$registros=$base->query("SELECT * FROM turnostriaje WHERE cc ='$cc_codigo' ORDER BY idtr DESC ")->fetchAll(PDO::FETCH_OBJ);
...
<div align="center">
    ...
    //  ------------------------------------Mostrar Conteo ---------------------------------------
            echo "<br><mark>Total atenciones :".$num_filas."</mark><br>";
        //  ------------------------------------ Fin Conteo ------------------------------------
  ?>  
  </div>
...
<div class="table-responsive">
  ...
  <?php
     ...
     ?> 
      ...
      <td><b><?php echo $fila->apellidos?></b></td>
      ...
      <td><?php echo $fila->medicacion?><td>
