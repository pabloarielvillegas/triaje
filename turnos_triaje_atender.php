...
<head>
	<meta charset="UTF-8">
	<title>HBC - Turnos de Emergencia</title>
...
// Array de objetos 
$registros=$base->query("SELECT * FROM turnostriaje WHERE e_turno='Registrado' ORDER BY prioridad_tm ASC LIMIT $empezar_desde, $tamano_paginas")->fetchAll(PDO::FETCH_OBJ);
...
<h2 align="Center">Registros Triaje de Emergencia (Prioridad)</h2> 
...
<div class="table-responsive">
  ...
  <?php
     ...
     ?> 
   	...
   	<tr>
       <td></td>
      <td><a href="turnos_triaje_atender_modificar.php?idtr=<?php echo $fila->idtr?>"><input type='button' name='up' id='up' value='Atender' class="btn btn-default active"></a></td>
