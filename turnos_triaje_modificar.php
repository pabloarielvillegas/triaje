...
<div class="container">
  ...
  <h2 align="Center">Edición de Turno</h2>


<form class="form-horizontal" action="turnos_triaje_modificar_procesar.php?idtr=<?php echo $fila->idtr; ?>" method="POST">
  ...
  <?php
    foreach($registros as $fila):
     ...
     ?> 
      ...
      <input type="text" name="f08" id="f08"  value="<?php echo $fila->f08?>"></td>
      ...
      <input type="text" name="nombres" id="nombres"  value="<?php echo $fila->nombres?>"></td>
       <th>CC</th>
      <td><label for="cc"></label>
      <input type="text" name="cc" id="cc"  value="<?php echo $fila->cc?>"></td>
      ...
      <th></th>
      <td></td>
     <td colspan="2"><input type="submit" name="bot_actualizar" id="bot_actualizar" value="Actualizar" class="btn btn-primary btn-lg btn-succes"></td>
      <td></td>
      <td></td>
      <td></td>
    </tr> 
